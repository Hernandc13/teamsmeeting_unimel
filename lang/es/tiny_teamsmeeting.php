...
$string['report_legend_replaced'] = 'Sesión reemplazada (duplicado antiguo)';
$string['report_badge_replaced'] = 'Reemplazada';
$string['report_badge_replaced_title'] = 'Existe una versión más reciente de esta sesión con el mismo título. Esta es la más antigua.';
$string['report_col_status'] = 'Estado';
$string['report_status_active'] = 'Activa';
$string['report_status_replaced'] = 'Reemplazada';
